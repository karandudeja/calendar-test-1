...
function DaysPassed(){
    ...
    return(
        <div>
            <div className="flex justify-between text-zinc-500 dark:text-zinc-600 text-sm md:text-base">
                <p>Day</p>
                <p>Days left</p>
            </div>
            <div className="flex justify-between">
                <p className="font-normal text-2xl dark:text-zinc-300">{daysPassed} <span className="font-normal text-sm text-zinc-400 dark:text-zinc-600">of {daysThisYear}</span></p>
                <p className="font-bold text-2xl ">{daysRemaining}</p>
            </div>
            <div className="w-full h-3 mt-1 xl:mt-2 rounded-full bg-zinc-100 flex">
            ...
            <div className="flex justify-between mt-1 xl:mt-2 text-xs">
